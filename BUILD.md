...
Создаст файл в `dist/sa-ui-operations-base-1.2.1.tar.gz`
...
Создаст файл в `dist/sa_ui_operations_base-1.2.1-py3-none-any.whl`
...
```bash
pip install dist/sa-ui-operations-base-1.2.1.tar.gz
```
